...
describe("Engineer", ()=>{
    ...
    describe("getRole and standard employee questions", ()=>{
        ...
        it("return employee questions and address the engineer role in the questions in lowercase", ()=>{
    ...
    describe("engineer questions to include asking for GitHub username but neither asking for an office number nor a school name", ()=>{
        const engineer = new Engineer('Moe', 3, 'engineer@gmail.com');
